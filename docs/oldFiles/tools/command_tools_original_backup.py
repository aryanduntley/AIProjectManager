...
"""
                ...
                if self.server_instance and hasattr(self.server_instance, 'on_workflow_completion'):
                    ...
                    try:
                        await self.server_instance.on_workflow_completion(workflow_context, "workflowManagement")
                    except Exception as hook_error:
                        logger.warning(f"Directive hook failed in _execute_init: {hook_error}")
        ...
        try:
            ...
            if self.server_instance and hasattr(self.server_instance, 'on_workflow_completion'):
                ...
                try:
                    ...
                    logger.warning(f"Directive hook failed in _execute_newTask: {hook_error}")
...
"""
            ...
            if self.server_instance and hasattr(self.server_instance, 'on_workflow_completion'):
                ...
                try:
                    ...
                    logger.warning(f"Directive hook failed in _execute_branch: {hook_error}")
        ...
        try:
            ...
            if self.server_instance and hasattr(self.server_instance, 'on_workflow_completion'):
                ...
                try:
                    ...
                    logger.warning(f"Directive hook failed in _execute_backup: {hook_error}")
        ...
        try:
            ...
            if self.server_instance and hasattr(self.server_instance, 'on_workflow_completion'):
                ...
                try:
                    ...
                    logger.warning(f"Directive hook failed in _execute_maintenance: {hook_error}")
